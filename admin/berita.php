...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main id="content" class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-4">
          ...
          <tbody class="table-primary">
            ...
            foreach ($news as $berita) : ?>
              <tr>
                ...
                <td id="img_<?=$berita['id']?>" ><img src="<?=$berita['img']?>" alt="" height="50" width="50"></td>
                <td id="title_<?= $berita['id'] ?>"><?= $berita['title'] ?></td>
                <td id="description_<?= $berita['id'] ?>"><?= $berita['description'] ?></td>
                <td style="width: 6%;" class="text-center">
                  <div class="d-flex justify-content-center">
                    <a class="nav-link " href="#" data-bs-toggle="modal" data-bs-target="#ubah-berita" onclick="loadUpdateNews(<?= $berita['id'] ?>)">
                    ...
                    <a href="#" class="nav-link text-danger" onclick="hapusBerita(<?= $berita['id'] ?>)">
        ...
        <button type="button" class="btn btn-outline-primary mx-2" data-bs-toggle="modal" data-bs-target="#tambah-berita">Tambah Berita</button>
  ...
  <div class="modal fade" id="tambah-berita" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form onsubmit="FormNews(event)" enctype="multipart/form-data" >
  ...
  <div class="modal fade" id="ubah-berita" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form onsubmit="FormNews(event)" enctype="multipart/form-data" >
            <input type="hidden" name="action" value="ubah berita"/>
